...
### Overall plot: the figure below shows the change of average preference ratings under the influences of different semantic features across six videos. The average ratings were scaled across six videos so that it was convenient to compare between videos.
...
### Results
Above is another figure that links the former graph with exmaple scenes at some significant points. The figure at the bottom shows the changes of the objective amount of trees. 
...
# Regression results 
### Visualization of the regression models
```{r}
include_graphics("dotwhsiker1.png")
include_graphics("dotwhsiker2.png")
include_graphics("dotwhsiker3.png")

```

### Results
Regressions models of preference ratings were built on different features in different videos. Not all the semantic features were presented in videos of each scene type.

<br>
Flat terrains: 
<br>Hue and variations in brightness, lower brightness and variations in hue and saturation might increase people’s preferences of the scene. Billboard and trees both negatively impacted the preference ratings. 

<br>
Rolling Hills: 
<br>Saturation and entropy, and variations in brightness, lower brightness and variations in saturation might increase people’s preferences for the scene. Lakes also contributed to a boost in the preference ratings, however trees had a negative effect. 

<br>
Mountainous forests: 
<br>Variations in hue, lower hue and brightness might increase people’s preferences for the scene. Lakes and trees also contributed to a boost in the preference ratings. 
